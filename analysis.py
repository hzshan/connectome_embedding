"""For analyzing learned embeddings.

Notations:
N - number of neurons / number of embedding vectors
D - dimensionality of the embedding vectors
...
def circ_score_via_norm(embeddings_2d, skip_alignment=False):
    ...
    # generate the target circle
    unit_circle = utils.make_circle(N)
