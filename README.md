...
Finally, the analysis of grid cells makes use of a synthetic medial entorhinal cortex (MEC) connectome. The code for generating it is included in the repository.
